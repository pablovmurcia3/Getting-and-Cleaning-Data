...
# functions take the form of ymd(), dmy(), hms(), ymd_hms(), etc., where each letter in
# the name of the function stands for the location of years (y), months (m), days (d),
# hours (h), minutes (m), and/or seconds (s) in the date-time being read in
...
this_moment <-update(this_moment, hours = 6, minutes = 13, seconds = 0)
